...
void main()
{
	...
	{		
		StepTime2 = 0.8+ 0.6*sin(realtime); // update new step time
		// the step period bigger than 1.8s should be limited at 1.8s. 
		// coz my previous study shows that period more than 1s you get 
		// the solution which is almost the same as period->OO. 
		// otherwise you need to reduce numerical simulation step
